...
.. _readthedocs: https://echofilter.readthedocs.io/en/1.2.1/usage/
...
`Usage Guide <https://echofilter.readthedocs.io/en/1.2.1/usage/>`__,
and the
`command line interface (CLI) reference <https://echofilter.readthedocs.io/en/1.2.1/programs/inference.html>`__
documentation.
...
`Usage Guide <https://echofilter.readthedocs.io/en/1.2.1/usage/installation.html#installing-as-an-executable-file>`__.
...
.. |GHA tests| image:: https://github.com/DeepSenseCA/echofilter/workflows/tests/badge.svg?branch=1.2.1
...
.. |readthedocs| image:: https://img.shields.io/badge/docs-readthedocs-blue
   :target: readthedocs_
   :alt: Documentation
.. |Documentation| image:: https://readthedocs.org/projects/echofilter/badge/?version=1.2.1
   :target: readthedocs_
