...
options = [
    ...
    "Tortuosity_2D",
    "Tortuosity_3D",
    "Distance_2D_Unsmoothed",
    "Distance_3D_Unsmoothed",
    "Species_Id",
    "Species_Name",
    "Species_Percent",
    "Species_TS",
    ...
    "First_Layer_Range_Start",
    "Last_Layer_Range_Stop",
    "Bad_Data_No_Data_Samples",
    "Beam_Volume_Sum",
    "No_Data_Samples",
    "C_Good_Samples",
    "C_Bad_Data_No_Data_Samples",
    "C_No_Data_Samples",
    ...
    "C_Bad_Data_Empty_Water_Samples",
