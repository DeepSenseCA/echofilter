...
conda install numpy pandas tqdm matplotlib seaborn jupyter pytorch torchvision -c https://public.dhe.ibm.com/ibmdl/export/pub/software/server/ibm-ai/conda/ -y
